  ...
  return (
    <div id='about'>
      ...
      <motion.p variants={fadeIn("", "", 0.1, 1)}
        ...
        I am a skilled software developer with experience in programming languages like JavaScript and Python along with databases like MongoDB and Oracle. I also possess expertise in libraries/frameworks like React.js and Node.js. I am a quick learner and collaborate closely with clients to create more efficient, scalable and user-friendly solutions that solve real-world problems. I am looking forward to contribute more in the software industry, at the same time I want to take my learnings and skill development to a next level.
      </motion.p>
        ...
        <Tilt className='min-[300px]:w-[250px] w-full'>
          <motion.div variants={fadeIn("right", "spring", "2", 0.75)}
            ...
            <div options={{ max: 45, scale: 1, speed: 450 }} className='bg-black rounded-[20px] py-5 px-12 min-h-[280px] flex flex-col justify-evenly items-center'>
              ...
              <h3 className='poppins text-white text-sm font-bold'>Python Programming</h3>
            </div>
          </motion.div>
        </Tilt>
      </div>
