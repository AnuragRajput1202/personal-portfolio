      ...
      <div className='absolute inset-0 sm:w-[80%] px-[3rem] top-[70px] mx-auto flex items-start gap-5'>
        ...
        <div>
          ...
          <div className="buttons flex max-[1166px]:flex-col max-[1166px]:items-start mt-32 items-center gap-12 max-md:hidden">
            <a href="https://drive.google.com/file/d/17Qo5NwDHcyvE_ZlVZ-jv0hsvoYAP-KF6/view?usp=drive_link" target="_blank" rel="noopener noreferrer"><button className='text-2xl max-lg:text-xl border border-[#C778DD] p-4 rounded-xl hover:bg-[#C778DD]'>Download CV</button></a>
          ...
          <a href="https://drive.google.com/file/d/17Qo5NwDHcyvE_ZlVZ-jv0hsvoYAP-KF6/view?usp=drive_link" target="_blank" rel="noopener noreferrer"><button className='border border-[#C778DD] p-2 rounded-lg hover:bg-[#C778DD]'>Download CV</button></a>
